...
var SystemsBlackSingleRail = function () {
    var pName = ["L225M", "P96", "P97", "P96L", "P97L", "X06", "X51" ];
     
    var menuName = "SystemsBlackSingleRail".concat("Imagebutton");
    var cssClass = ".slides_control .";
   
    var textArray = ["880 lm", "MR16", "MR16", "660 lm LEDs", "660 lm LEDs", "MR16", "MR16" ];
...
.slides_control .SystemsBlackSingleRailImagebuttonX516 \
').hover(function (e) {
